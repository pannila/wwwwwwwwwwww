                  ...
                  ctx.drawImage(ground, 0, 0, 540, 230);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '25px';
                              ctx.fillStyle = "#8ad8b6";
                                ctx.fillText(member.user.username, 239, 221);
                              
                              //NAMEً
                              ctx.font = '21px kathen';
                              ctx.fontSize = '20px';
                              ctx.fillStyle = "#FFFFFF";
      ctx.fillText(`Welcome To ${member.guild.name}`, 167, 181);
                              ...
                              ava.src = buf;
                              ctx.beginPath();
                 ctx.arc(269, 92, 140, 0, Math.PI*2, true);
                   ctx.closePath();
                   
                                 ctx.clip();

                        ctx.drawImage(ava, 111, 111, 111, 111);
                              ctx.closePath();
